...
class Lion(Mammal):
    '''
    An abstract class which represents a lion and inherits from the Mammal class.
    ...
    Attributes:
        ...
        environment_types : A list of strings indicating which environments the animal can live in. Set to ["grassland"].
