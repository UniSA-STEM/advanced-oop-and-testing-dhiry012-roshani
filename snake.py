...
class Snake(Reptile):
    '''
    An abstract class which represents a snake and inherits from the Reptile class.
    ...
    Attributes:
        ...
        environment_types : A list of strings indicating which environments the animal can live in. Set to ["tropical", "grassland", "desert", "forest", "wetland"].
