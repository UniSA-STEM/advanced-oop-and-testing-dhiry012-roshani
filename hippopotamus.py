...
class Hippopotamus(Mammal):
    '''
    An abstract class which represents a hippopotamus and inherits from the Mammal class.
    ...
    Attributes:
        ...
        environment_types : A list of strings indicating which environments the animal can live in. Set to ["tropical", "grassland", "freshwater aquatic", "wetland"].
