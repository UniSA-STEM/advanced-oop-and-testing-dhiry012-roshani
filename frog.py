...
class Frog(Amphibian):
    '''
    A class which represents a frog and inherits from the Amphibian class.
    ...
    Attributes:
        ...
        environment_types : A list of strings indicating which environments the animal can live in. Set to ["wetland", "tropical", "forest", "freshwater aquatic"].
