...
class Penguin(Bird):
    '''
    An abstract class which represents a penguin and inherits from the Bird class.
    ...
    Attributes:
        ...
        environment_types : A list of strings indicating which environments the animal can live in. Set to ["saltwater aquatic", "arctic"].
